...
//				System.out.println("True = "+trueClass+" Predicted = "+predictedClass);
			}catch(Exception e){System.out.println(" Error with instance "+i);}
		}
		return a/size;
	}	
 ...
 */
	 ...
	 * useful for e.g McNemar's test (and cv variance). Note that the use of FastVector has been depreciated * @param c
	 * @param allData
	 * @param m
	 * @return
	 */
