 ...
 * */
public class Moments extends SimpleBatchFilter {
...
**/
          ...
          //Extract out the terms and set the attributes
            ...
            if(inst.classIndex()>=0)
                    newInst=new Instance(numMoments+1);
            else
                    newInst=new Instance(numMoments);
